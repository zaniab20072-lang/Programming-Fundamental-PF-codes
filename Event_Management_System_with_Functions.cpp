    ...
    while (true)
    {
        ...
        else if (user_option == "2")
        {
            while (true)
            {
                ...
                {
                    Booking_Tickets(customer_name, index, EventName_Array, event_name, seats, RemainingSeats_Array, total_price, TicketPrice_Array, CustomerName_Array, BookingBill_Array, BookingEvent_Array, BookingSeats_Array, booking_index);
                }
                ...
                {
                    Cancel_Seats(RemainingSeats_Array, BookingSeats_Array, BookingBill_Array, TicketPrice_Array, cancel_seats, CustomerName_Array, BookingEvent_Array, customer_name, event_name, booking_index);
                }
